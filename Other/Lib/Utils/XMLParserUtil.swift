...
extension XMLParserUtil {
    func parser(_ parser: XMLParser, didStartElement elementName: String, namespaceURI: String?, qualifiedName qName: String?, attributes attributeDict: [String : String] = [:]) {
        ...
        if elementName == "img" {
            ...
            currentModel = XMLContentModel()
            currentElement = "a"
            currentValue = attributeDict["href"] != nil ? attributeDict["href"] : attributeDict["name"]
            currentModel!.contentType = .XMLContentTypeA
            currentModel!.content = attributeDict["href"] != nil ? attributeDict["href"] : attributeDict["name"]!
        }
    }
