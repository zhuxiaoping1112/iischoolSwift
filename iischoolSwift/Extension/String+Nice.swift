...
extension String{
    ...
    func getImageSizeWithURL() -> CGSize {
        ...
        var width = CGFloat(truncating: widthFormatter!)
        var height = CGFloat(truncating: heightFormatter!)
        if width > UIConstant.SCREEN_WIDTH - 20 {
            width = UIConstant.SCREEN_WIDTH - 20
            height = width * height / CGFloat(truncating: widthFormatter!)
        }
