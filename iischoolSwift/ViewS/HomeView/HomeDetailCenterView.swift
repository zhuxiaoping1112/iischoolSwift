...
class HomeDetailCenterView: UIScrollView {
    ...
    private func setupOtherData() {
        ...
        #if false //使用lable的attributedText 展示htmL 有图片的展示不好.. 所以还是用去标签截取来做.
        ...
        let newStr : String = String(format: "<head><style>img{width:%f !important;height:aotu}</style></head>%@", arguments:[UIConstant.SCREEN_WIDTH,model.content])
        do {
